...
test('eight original lists, artwork, native cards, guides, AI profiles and repeatable intake',()=>{
 assert.equal(Object.keys(M.DECKS).length,170);assert.equal(Object.keys(M.DEFS).length,3975+M.ORACLE_BATCHES.filter(batch=>/^oracle-\d{4}$/.test(batch.id)).reduce((n,batch)=>n+batch.cards.length,0));
