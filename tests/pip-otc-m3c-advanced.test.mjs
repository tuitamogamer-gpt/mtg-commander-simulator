...
test('ten original lists, 214 native additions and complete player guides',()=>{
 ...
 assert.equal(Object.keys(M.DECKS).length,175);assert.equal(Object.keys(M.DEFS).length,3992+M.ORACLE_BATCHES.filter(batch=>/^oracle-\d{4}$/.test(batch.id)).reduce((n,batch)=>n+batch.cards.length,0));
