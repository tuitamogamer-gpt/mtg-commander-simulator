...
test('ten original 100-card precons preserve source lists, native implementations, guides, images and default pairs',()=>{
 ...
 assert.equal(Object.keys(M.DECKS).length,153);assert.equal(M.CATALOG_SUMMARY.importableCards,Object.values(M.CARD_CATALOG).filter(card=>card.deckImportEligible).length);
});
