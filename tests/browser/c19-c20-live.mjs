...
const out = (outputIndex >= 0 ? process.argv[outputIndex + 1] : process.env.GAME_QA_OUTPUT) || `${root}output/precon-c19-c20-znc-2026-09-08/live`;
...
try {
  ...
  await host.locator('.deckentry[data-deck="Enhanced Evolution"] .deckcard').click();
  ...
  const botDecks = ['Ruthless Regiment', 'Arcane Maelstrom', 'Sneak Attack'];
