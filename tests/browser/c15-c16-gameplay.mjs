...
const out = process.env.PLAYER_GAMEPLAY_QA_OUTPUT || 'output/precon-c15-c16-2026-09-08/mobile-game-final';
...
try {
  ...
  await page.locator('.decksearch input').fill(process.env.PLAYER_HUMAN_DECK || 'Wade into Battle');
  ...
  await page.locator('.botfields .deckselect').selectOption(process.env.PLAYER_AI_DECK || 'Swell the Host');
