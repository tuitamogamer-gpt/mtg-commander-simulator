...
const out = process.env.PLAYER_GAMEPLAY_QA_OUTPUT || 'output/precon-clb-dmc-40k-2026-09-09/natural-game';
...
try {
  ...
  await page.locator('.decksearch input').fill(process.env.PLAYER_HUMAN_DECK || 'Necron Dynasties');
  ...
  await page.locator('.botfields .deckselect').selectOption(process.env.PLAYER_AI_DECK || 'Tyranid Swarm');
