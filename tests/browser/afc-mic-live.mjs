...
const out = (outputIndex >= 0 ? process.argv[outputIndex + 1] : process.env.GAME_QA_OUTPUT) || `${root}output/precon-afc-mic-2026-09-09/live`;
...
try {
  ...
  await host.locator('.deckentry[data-deck="Planar Portal"] .deckcard').click();
  ...
  const botDecks = ["Draconic Rage", 'Dungeons of Death', 'Aura of Courage'];
