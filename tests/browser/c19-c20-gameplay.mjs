...
const out = process.env.PLAYER_GAMEPLAY_QA_OUTPUT || 'output/precon-c19-c20-znc-2026-09-08/natural-game';
...
try {
  ...
  await page.locator('.decksearch input').fill(process.env.PLAYER_HUMAN_DECK || 'Sneak Attack');
  ...
  await page.locator('.botfields .deckselect').selectOption(process.env.PLAYER_AI_DECK || 'Ruthless Regiment');
