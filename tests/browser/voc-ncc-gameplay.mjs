...
const out = process.env.PLAYER_GAMEPLAY_QA_OUTPUT || 'output/precon-voc-ncc-2026-09-09/natural-game';
...
try {
  ...
  await page.locator('.decksearch input').fill(process.env.PLAYER_HUMAN_DECK || 'Spirit Squadron');
  ...
  await page.locator('.botfields .deckselect').selectOption(process.env.PLAYER_AI_DECK || 'Upgrades Unleashed');
