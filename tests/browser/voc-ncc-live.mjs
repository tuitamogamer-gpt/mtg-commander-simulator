...
const out = (outputIndex >= 0 ? process.argv[outputIndex + 1] : process.env.GAME_QA_OUTPUT) || `${root}output/precon-voc-ncc-2026-09-09/live`;
...
try {
  ...
  await host.locator('.deckentry[data-deck="Buckle Up"] .deckcard').click();
  ...
  const botDecks = ["Heads I Win, Tails You Lose", 'Maestros Massacre', 'Cabaretti Cacophony'];
