...
test('five exact original precons, native definitions, artwork, guides and commander pairs',()=>{
 ...
 assert.equal(Object.keys(M.DECKS).length,175);assert.equal(M.CATALOG_SUMMARY.importableCards,Object.values(M.CARD_CATALOG).filter(card=>card.deckImportEligible).length);
});
