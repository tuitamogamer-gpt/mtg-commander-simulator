...
import {precons as bdfPrecons} from '../scripts/import-blc-dsc-sld-drc-fic-precons.mjs';
import {precons as socPrecons} from '../scripts/import-soc-precons.mjs';
import {precons as pomPrecons} from '../scripts/import-pip-otc-m3c-precons.mjs';
import {precons as wlmPrecons} from '../scripts/import-who-lcc-sld-mkc-precons.mjs';
import {precons as cslPrecons} from '../scripts/import-cmd-sld-precons.mjs';
import {precons as finalPrecons} from '../scripts/import-c13-td0-sld-precons.mjs';
import {precons as frcPrecons} from '../scripts/import-frc-precon.mjs';
import {precons as fdcPrecons} from '../scripts/import-fdc-precons.mjs';
...
test('175 predefined decks use available videos or a still image; custom decks never inherit videos', () => {
  const predefined = Object.values(MTG.DECKS).filter(deck => !deck.custom && !deck.imported);
  assert.equal(predefined.length, 175);
