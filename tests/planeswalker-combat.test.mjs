...
test('svih 95 deck/planeswalker parova ima svih 264 loyalty putanja', () => {
  const inventory = [];
  ...
  assert.deepEqual(inventory, [
    ...
    ['First Flight', 'Gideon Jura'],
    ['Grave Danger', 'Liliana, Untouched by Death'],
    ...
    ['Invent Superiority', 'Daretti, Scrap Savant'],
    ...
    ['Merciless Rage', 'Ob Nixilis Reignited'],
    ['Primal Genesis', 'Garruk, Primal Hunter'],
    ['Mystic Intellect','Ral Zarek'],
    ['Faceless Menace','Vraska the Unseen'],
    ['Timeless Wisdom','Chandra, Flamecaller'],
    ['Enhanced Evolution','Nissa, Steward of Elements'],
    ['Ruthless Regiment','Nahiri, the Harbinger'],
    ['Arcane Maelstrom','Jace, Architect of Thought'],
    ['Symbiotic Swarm','Ajani Unyielding'],
    ['Undead Unleashed',"Liliana, Death's Majesty"],
    ['Spirit Squadron','Dovin, Grand Arbiter'],
    ['Buckle Up','Jace, Architect of Thought'],
    ['Heads I Win, Tails You Lose','Daretti, Scrap Savant'],
    ['Heads I Win, Tails You Lose','Ral Zarek'],
    ['Bedecked Brokers','Ajani Unyielding'],
    ['Draconic Dissent','Will Kenrith'],
    ['Draconic Dissent','Rowan Kenrith'],
    ['Exit from Exile','Vivien, Champion of the Wilds'],
    ...
    ["Enduring Enchantments","Calix, Destiny's Hand"],
    ["Eldrazi Unbound","Ugin, the Ineffable"],
    ["Blood Rites","Sorin, Lord of Innistrad"],
    ["Graveyard Overdrive","Liliana, Death's Majesty"],
    ["Graveyard Overdrive","Garruk, Apex Predator"],
    ["Graveyard Overdrive","Grist, the Hunger Tide"],
    ["Tricky Terrain","Nissa, Steward of Elements"],
    ["Tricky Terrain","Vivien Reid"],
    ["Eldrazi Incursion","Ugin, the Ineffable"],
    ["Peace Offering","Tamiyo, Field Researcher"],
    ["Death Toll","Ob Nixilis Reignited"],
    ["Death Toll","Professor Onyx"],
    ["Death Toll","Wrenn and Seven"],
    ["Death Toll","Grist, the Hunger Tide"],
    ["20 Ways to Win","The Eternal Wanderer"],
    ...
    ["Multiverse Reforged","Elspeth, Sun's Champion"],
  ]);
  assert.equal(inventory.reduce((sum, [, name]) => sum + MTG.DEFS[name].abilities.filter(a => a.loyalty !== undefined).length, 0), 264);
