...
test('svih 81 deck/planeswalker parova ima svih 225 loyalty putanja', () => {
  const inventory = [];
  ...
  assert.equal(inventory.reduce((sum, [, name]) => sum + MTG.DEFS[name].abilities.filter(a => a.loyalty !== undefined).length, 0), 225);
