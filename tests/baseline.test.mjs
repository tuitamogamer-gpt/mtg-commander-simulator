...
test('raw snapshot čuva 111 deckova, a proizvod koristi certifikovani set od 110', () => {
  assert.equal(raw.decks.length, 111);
  assert.equal(report.deckRows.length, 110);
