...
test('raw snapshot čuva 116 deckova, a proizvod koristi certifikovani set od 115', () => {
  assert.equal(raw.decks.length, 116);
  assert.equal(report.deckRows.length, 115);
