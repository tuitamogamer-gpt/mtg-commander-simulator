...
test('raw snapshot čuva 161 deckova, a proizvod koristi certifikovani set od 160', () => {
  assert.equal(raw.decks.length, 161);
  assert.equal(report.deckRows.length, 160);
