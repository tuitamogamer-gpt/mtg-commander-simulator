...
test('raw snapshot čuva 121 deckova, a proizvod koristi certifikovani set od 120', () => {
  assert.equal(raw.decks.length, 121);
  assert.equal(report.deckRows.length, 120);
