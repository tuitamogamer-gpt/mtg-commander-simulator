...
test('raw snapshot čuva 141 deckova, a proizvod koristi certifikovani set od 140', () => {
  assert.equal(raw.decks.length, 141);
  assert.equal(report.deckRows.length, 140);
