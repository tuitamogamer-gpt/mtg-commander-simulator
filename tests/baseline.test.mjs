...
test('raw snapshot čuva 154 deckova, a proizvod koristi certifikovani set od 153', () => {
  assert.equal(raw.decks.length, 154);
  assert.equal(report.deckRows.length, 153);
