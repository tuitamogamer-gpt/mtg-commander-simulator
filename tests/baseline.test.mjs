...
test('raw snapshot čuva 151 deckova, a proizvod koristi certifikovani set od 150', () => {
  assert.equal(raw.decks.length, 151);
  assert.equal(report.deckRows.length, 150);
