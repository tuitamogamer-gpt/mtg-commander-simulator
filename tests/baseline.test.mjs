...
test('svih 169 originalnih deckova dostupno je u proizvodu, uključujući Blame Game', () => {
  assert.equal(raw.decks.length, 169);
  assert.equal(report.deckRows.length, 169);
