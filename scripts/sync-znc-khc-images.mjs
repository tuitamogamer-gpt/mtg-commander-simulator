...
import {sourceDir,outputDir} from './import-znc-cmr-khc-precons.mjs';
...
const variants=[['Ranar the Ever-Watchful','Spirit','KHC Spirit'],['Replicating Ring','Replicated Ring','Replicated Ring']];
