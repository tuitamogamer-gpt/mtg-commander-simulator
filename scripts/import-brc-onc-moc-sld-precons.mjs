...
export const sourceDir=path.resolve(path.dirname(fileURLToPath(import.meta.url)),'../reports/decks/precon-brc-onc-moc-sld-2026-09-09');
export const outputDir=path.resolve(sourceDir,'../../../output/precon-brc-onc-moc-sld-2026-09-09');
export const precons=[
  [
    "Mishra's Burnished Banner",
    "Mishra, Eminent One",
    "BRC",
    "2SN7rtbtuEy6rydE2U55gA"
  ],
  [
    "Urza's Iron Alliance",
    "Urza, Chief Artificer",
    "BRC",
    "yvrb9gEkuUSVBT0ulhjxfA"
  ],
  [
    "Rebellion Rising",
    "Neyali, Suns' Vanguard",
    "ONC",
    "RHTNEgHYMUigpM8XFwqUeQ"
  ],
  [
    "Corrupting Influence",
    "Ixhel, Scion of Atraxa",
    "ONC",
    "PvZAYgl5MUWsWFdKKdyIww"
  ],
  [
    "Tinker Time",
    "Gimbal, Gremlin Prodigy",
    "MOC",
    "-QW0UquytEiCFJE72zE59w"
  ],
  [
    "Growing Threat",
    "Brimaz, Blight of Oreskos",
    "MOC",
    "Rwg0cZ0Yqk2ujq_GXIQA2g"
  ],
  [
    "Divine Convocation",
    "Kasla, the Broken Halo",
    "MOC",
    "SfNm_azRAUGtkhIuesdBIw"
  ],
  [
    "Cavalry Charge",
    "Sidar Jabari of Zhalfir",
    "MOC",
    "PrHvjllh3kuzVuSV2wyhCQ"
  ],
  [
    "Call for Backup",
    "Bright-Palm, Soul Awakener",
    "MOC",
    "9jXNLpQrv0CQN-d5sJeHFA"
  ],
  [
    "From Cute to Brute",
    "Esika, God of the Tree",
    "SLD",
    "8wdob7tqoUujv-Ifp0S3cw"
  ]
...
const officialUrls=[
  {
    "set": "BRC",
    "file": "brc.html",
    "url": "https://magic.wizards.com/en/news/announcements/brothers-war-commander-decklists-2022-10-28"
  },
  {
    "set": "ONC",
    "file": "onc.html",
    "url": "https://magic.wizards.com/en/news/announcements/phyrexia-all-will-be-one-commander-decklists"
  },
  {
    "set": "MOC",
    "file": "moc.html",
    "url": "https://magic.wizards.com/en/news/announcements/march-of-the-machine-commander-decklists"
  },
  {
    "set": "SLD",
    "file": "sld.html",
    "url": "https://magic.wizards.com/en/news/announcements/commander-returns-to-secret-lair-with-from-cute-to-brute"
  }
];
const sha=t=>crypto.createHash('sha256').update(t).digest('hex');
// Reversible Secret Lair artwork prints the same identity on both faces.
const canonical=n=>n.replace(/<[^>]*>/g,'').replaceAll('Æ','Ae').replaceAll('æ','ae').replaceAll('’',"'").replace(/\s*\/{2,3}\s*/g,' // ').trim().replace(/^(.+) \/\/ \1$/,'$1');
...
async function sources(){
  ...
  write(path.join(sourceDir,'decklists.json'),{retrievedOn:'2026-09-09',selection:'After Warhammer 40K, by MTGJSON release order and pinned-index order within each edition: BRC, ONC, MOC, then From Cute to Brute. Already imported Starter precons are skipped. Preserve every original card regardless of legality. No substitutions or alternate-edition duplicates.',moxfieldAccess:'The pinned index supplies queue links. These are verified Wizards / MTGJSON lists, not direct Moxfield exports.',normalization:'Flip, Adventure and double-faced cards use their front names for source comparison and resolve to existing canonical aliases during intake; split cards retain their combined names. Full Scryfall faces are preserved in oracle.json.',decks});
}
