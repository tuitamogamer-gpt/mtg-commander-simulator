...
import {sourceDir,outputDir} from './import-pip-otc-m3c-precons.mjs';
...
const variants=[
 ['Dogmeat, Ever Loyal','Junk','POM Junk'],
 ['Moira Brown, Guide Author','Wasteland Survival Guide','POM Wasteland Survival Guide'],
 ['Preston Garvey, Minuteman','Settlement','POM Settlement'],
 ["Caesar, Legion's Emperor",'Soldier','POM Soldier RW'],
 ['White Glove Gourmand','Human Soldier','POM Human Soldier'],
 ['Screeching Scorchbeast','Zombie Mutant','POM Zombie Mutant'],
 ['Mr. House, President and CEO','Robot','POM Robot'],
 ['Hazezon, Shaper of Sand','Sand Warrior','POM Sand Warrior'],
 ['Jyoti, Moag Ancient','Forest Dryad','POM Forest Dryad'],
 ['Angelic Aberration','Eldrazi Angel','POM Eldrazi Angel'],
 ['Disa the Restless','Tarmogoyf','POM Tarmogoyf'],
 ['Chittering Dispatcher','Eldrazi Spawn','POM Eldrazi Spawn'],
 ['Void Attendant','Eldrazi Scion','POM Eldrazi Scion'],
];
