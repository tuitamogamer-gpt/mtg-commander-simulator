...
import {sourceDir,buildIntake} from './import-c17-c19-precons.mjs';
const base='1662ff2',sha=s=>crypto.createHash('sha256').update(s).digest('hex');
...
assert.equal(Object.keys(current.cards).length-Object.keys(previous.cards).length,170);assert.equal(current.decks.length-previous.decks.length,10);
