...
import {sourceDir,outputDir} from './import-who-lcc-sld-mkc-precons.mjs';
...
const variants=[
 ['Davros, Dalek Creator','Dalek','WHO Dalek'],['Clavileño, First of the Blessed','Vampire Demon','LCC Vampire Demon'],
 ['Charismatic Conqueror','Vampire','LCC Vampire'],['Emperor Mihail II','Merfolk','LCC Merfolk'],
 ['Blink','Alien Angel','WHO Alien Angel'],['Brimaz, King of Oreskos','Cat Soldier','SLD Cat Soldier'],
 ['Skeleton Crew','Skeleton Pirate','LCC Skeleton Pirate'],['Vrestin, Menoptra Leader','Alien Insect','WHO Alien Insect'],
 ['Fugitive of the Judoon','Human','WHO Human Ward'],['Fugitive of the Judoon','Alien Rhino','WHO Alien Rhino'],
 ['Quartzwood Crasher','Dinosaur Beast','LCC Dinosaur Beast'],['Printlifter Ooze','Ooze','MKC Ooze'],
 ['The Curse of Fenric','Mutant','WHO Mutant'],['The War Games','Warrior','WHO Warrior'],
 ['The Rani','Mark of the Rani','WHO Mark of the Rani'],['Sorin, Lord of Innistrad','Vampire','LCC Black Vampire']
];
