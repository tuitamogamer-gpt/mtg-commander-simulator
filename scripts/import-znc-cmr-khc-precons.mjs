...
export const sourceDir=path.resolve(path.dirname(fileURLToPath(import.meta.url)),'../reports/decks/precon-znc-cmr-khc-2026-09-08');
export const outputDir=path.resolve(sourceDir,'../../../output/precon-znc-cmr-khc-2026-09-08');
export const precons=[
  [
    "Land's Wrath",
    "Obuun, Mul Daya Ancestor",
    "ZNC",
    "hxxwZ5fXHEWBIKbY3HEpxQ"
  ],
  [
    "Arm for Battle",
    "Wyleth, Soul of Steel",
    "CMR",
    "B5nugPBRnkWIookZqo9N4g"
  ],
  [
    "Reap the Tides",
    "Aesi, Tyrant of Gyre Strait",
    "CMR",
    "K3C1rLmFKE-14OeUeHxdYQ"
  ],
  [
    "Phantom Premonition",
    "Ranar the Ever-Watchful",
    "KHC",
    "Go1B3kYCPk6ckaI7hPdShw"
  ],
  [
    "Elven Empire",
    "Lathril, Blade of the Elves",
    "KHC",
    "diwSjxSEw0O9MDyJU9EYkg"
  ]
...
const officialUrls=[
  ...
  },
  {
    "set": "CMR",
    "file": "cmr.html",
    "url": "https://magic.wizards.com/en/news/feature/commander-legends-commander-decklists-2020-11-05"
  },
  {
    "set": "KHC",
    "file": "khc.html",
    "url": "https://magic.wizards.com/en/news/card-preview/kaldheim-commander-decklists-2021-01-20"
  }
];
...
async function sources(){
  ...
  if(official.length!==6)throw Error('Expected six original lists across ZNC, CMR and KHC');
  ...
  write(path.join(sourceDir,'decklists.json'),{retrievedOn:'2026-09-08',selection:'After Sneak Attack: Land’s Wrath (ZNC), both Commander Legends lists, and both Kaldheim Commander lists, using the pinned index order within each release. Preserve every original card regardless of legality. No substitutions or alternate-edition duplicates.',moxfieldAccess:'The pinned index supplies queue links. These are verified Wizards / MTGJSON lists, not direct Moxfield exports.',normalization:'Flip and Adventure cards retain their front names; split cards retain their combined names. Full Scryfall faces are preserved in oracle.json.',decks});
}
