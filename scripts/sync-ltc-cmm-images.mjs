...
import {sourceDir,outputDir} from './import-ltc-cmm-precons.mjs';
...
const variants=[
 ['Farmer Cotton','Halfling','LTC Halfling'],['Brood Sliver','Sliver','CMM Sliver'],
 ['Forth Eorlingas!','Human Knight','LTC Human Knight'],['In the Darkness Bind Them','Wraith','LTC Wraith'],
 ['Gwaihir, Greatest of the Eagles','Bird','LTC Bird'],['Wake the Dragon','Dragon','LTC Dragon'],
 ['Assemble the Entmoot','Treefolk','LTC Treefolk'],['Commodore Guff','Wizard','CMM Wizard'],
 ['Teyo, Geometric Tactician','Wall','CMM Wall']
];
...
const canonicalAliases = {'Halfling':'LTC Halfling','Sliver':'CMM Sliver','Human Knight':'LTC Human Knight','Wraith':'LTC Wraith'};
