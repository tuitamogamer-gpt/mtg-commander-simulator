...
import {buildIntake, sourceDir} from './import-frc-precon.mjs';

const baseline = 'bd1bba00aa0db32ad8cd429ff4765197fbddf6af';
...
execFileSync(process.execPath, ['scripts/import-frc-precon.mjs', '--write'], {stdio: 'pipe', maxBuffer: 5_000_000});
...
const result = {
  baseline, passed: true, originalPhysicalCards: 100, uniqueNames: intake.names.length,
