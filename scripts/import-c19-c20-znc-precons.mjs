...
export const sourceDir=path.resolve(path.dirname(fileURLToPath(import.meta.url)),'../reports/decks/precon-c19-c20-znc-2026-09-08');
export const outputDir=path.resolve(sourceDir,'../../../output/precon-c19-c20-znc-2026-09-08');
export const precons=[
  ["Mystic Intellect", "Sevinne, the Chronoclasm", "C19", "HQVV0USd-ECJa_7kyXdsnw"],
  [
    "Faceless Menace",
    "Kadena, Slinking Sorcerer",
    "C19",
    "gBEKby17r0OMidKZzGZfYQ"
  ],
  [
    "Timeless Wisdom",
    "Gavi, Nest Warden",
    "C20",
    "FoYllHo-K0WwAeO4uX5uLg"
  ],
  [
    "Enhanced Evolution",
    "Otrimi, the Ever-Playful",
    "C20",
    "LWso_KepWEGAF8XjYQuH9Q"
  ],
  [
    "Ruthless Regiment",
    "Jirina Kudro",
    "C20",
    "7a4bmlDVbEeIlvXYrlTIIA"
  ],
  [
    "Arcane Maelstrom",
    "Kalamax, the Stormsire",
    "C20",
    "tNJbhqMb_U-azRDNGIBooA"
  ],
  [
    "Symbiotic Swarm",
    "Kathril, Aspect Warper",
    "C20",
    "VdxcZ7n6skOrhuElFAa5bg"
  ],
  [
    "Sneak Attack",
    "Anowon, the Ruin Thief",
    "ZNC",
    "xaAqhJektkCFh_HAR8cBMg"
  ]
...
const officialUrls=[
  {
    "set": "C19",
    "file": "c19.html",
    "url": "https://magic.wizards.com/en/news/feature/decks-commander-2019-edition-2019-08-08"
  },
  {
    "set": "C20",
    "file": "timeless-wisdom.html",
    "url": "https://magic.wizards.com/en/news/announcements/timeless-wisdom-2020-04-06"
  },
  {
    "set": "C20",
    "file": "enhanced-evolution.html",
    "url": "https://magic.wizards.com/en/news/announcements/enhanced-evolution-2020-04-06"
  },
  {
    "set": "C20",
    "file": "ruthless-regiment.html",
    "url": "https://magic.wizards.com/en/news/announcements/ruthless-regiment-2020-04-06"
  },
  {
    "set": "C20",
    "file": "arcane-maelstrom.html",
    "url": "https://magic.wizards.com/en/news/announcements/arcane-maelstrom-2020-04-06"
  },
  {
    "set": "C20",
    "file": "symbiotic-swarm.html",
    "url": "https://magic.wizards.com/en/news/announcements/symbiotic-swarm-2020-04-06"
  },
  {
    "set": "ZNC",
    "file": "znc.html",
    "url": "https://magic.wizards.com/en/news/card-preview/zendikar-rising-commander-decklists-2020-09-09"
  }
];
...
async function sources(){
  ...
  if(official.length!==11)throw Error('Expected eleven original lists across C19, C20 and ZNC');
  ...
  write(path.join(sourceDir,'decklists.json'),{retrievedOn:'2026-09-08',selection:'After C17-C19: the remaining two C19 lists, all five C20 lists, then Sneak Attack (ZNC). User explicitly requested original cards regardless of Commander legality; Dockside Extortionist is retained with its banned status. No substitutions or alternate-edition duplicates.',moxfieldAccess:'The pinned index supplies queue links. These are verified Wizards / MTGJSON lists, not direct Moxfield exports.',normalization:'Flip and Adventure cards retain their front names; split cards retain their combined names. Full Scryfall faces are preserved in oracle.json.',decks});
}
async function oracle(){
  ...
  const cards=names.map(name=>{const c=byName.get(name)||byName.get(name.split(' // ')[0]);if(!c)throw Error('Missing Oracle '+name);
    if(!['normal','flip','saga','mutate','adventure','split'].includes(c.layout))throw Error('Unsupported layout '+c.layout+': '+name);
