...
import {sourceDir,outputDir} from './import-voc-ncc-precons.mjs';
...
const variants=[['Chishiro, the Shattered Blade','Spirit','NEC Spirit'],['Concord with the Kami','Spirit','NEC Colorless Spirit'],['Shorikai, Genesis Engine','Pilot','NEC Pilot'],['Goblin Kaboomist','Land Mine','Land Mine'],['Rekindling Phoenix','Elemental','Phoenix Elemental'],['Zurzoth, Chaos Rider','Devil','NCC Devil'],["Smoke Spirits' Aid",'Smoke Blessing','Smoke Blessing'],['Waste Management','Rogue','NCC Rogue']];
...
const canonicalAliases = {'Pilot':'NEC Pilot'};
