...
import {sourceDir,outputDir} from './import-cmd-sld-precons.mjs';
...
const variants=[['Frontline Heroism','Soldier','CSL Soldier'],['Triskelavus','Triskelavite','CSL Triskelavite'],['Voice of Resurgence','Elemental','CSL Elemental'],['Phyrexian Processor','Minion','CSL Phyrexian Minion']];
