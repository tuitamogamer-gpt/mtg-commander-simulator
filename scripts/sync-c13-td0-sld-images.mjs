...
import {sourceDir,outputDir} from './import-c13-td0-sld-precons.mjs';
...
const variants=[['Springjack Pasture','Goat','C13 Goat'],['Prossh, Skyraider of Kher','Kobolds of Kher Keep','C13 Kobold'],['Endrek Sahr, Master Breeder','Thrull','C13 Thrull'],['Ajani, Strength of the Pride',"Ajani’s Pridemate",'C13 Pridemate'],['Marath, Will of the Wild','Elemental','C13 Elemental'],['The Book of Exalted Deeds','Angel','C13 Angel']];
...
fs.writeFileSync(reportFile,JSON.stringify({date:'2026-09-19',source:'Pinned Scryfall card and linked token metadata',added,addedCount:added.length,canonicalAliases,sourceCardsWithLocalImages:records.length,tokenVariants:variants.map(([source,name,alias])=>({source,name,alias,scryfallId:tokens[alias].id})),existingImagesUnchanged:true},null,2)+'\n');
