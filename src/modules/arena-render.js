...
(function () {
  ...
  const scrollSelector = '.hand, .myboard, .oppsouter, .oppswrap, .oppstrip, .boardlanecards, .oppresourcecards, .manaartifactstrip, .landstrip, .ct-decision-content, .ct-review-body, .actionstageinfo, .sidebar, .sidelog, .overlay, .modal, .attackalloclanes, .attackpool, .sheet, .quickmenu';
