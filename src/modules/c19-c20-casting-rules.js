...
(function(){
 ...
 function offers(g,p){
  ...
  for(const r of g.c1920CastGrants||[]){const c=g.byIid(r.card);if(r.player!==p.idx||r.used||!c||c.zone!==r.zone||c.zoneVersion!==r.version||!c.owner[c.zone]?.includes(c)||r.turn!==undefined&&r.turn!==g.turnNo)continue;
