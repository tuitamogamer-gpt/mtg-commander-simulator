...
(function(){
 ...
 G.isProtectedFrom=function(target,source,options){if(source&&target instanceof M.Player&&this.untilEffects.some(e=>e.kind==='c1920PlayerProtection'&&e.who===target&&e.from===(source.ctrl||source.owner)?.idx))return true;return protectedFrom.call(this,target,source,options);};
