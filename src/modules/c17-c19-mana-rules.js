...
(function(){
 ...
 const hooks=(g,land,p)=>g.bf().filter(c=>C.live(c)&&(c.def.bomKinnan&&!land.is('Land')&&c.ctrl===p||c.def.c1719LandMana&&land.is('Land')&&(c.def.c1719LandMana.attached?c.attachedTo===land.iid:c.ctrl===p)));
