...
"Paradox Power": {
  ...
  "Deadly Disguise": {
    ...
    "Enduring Enchantments": {"archetype": "Enchantment reanimation", "length": "long", "tags": ["enchantments", "graveyard", "tokens"], "commanderImportance": 1.5},
    "Eldrazi Unbound": {"archetype": "Colorless ramp and cascade", "length": "long", "tags": ["ramp", "colorless", "cascade"], "commanderImportance": 1.5},
    "Virtue and Valor": {"archetype": "Auras and Roles", "length": "long", "tags": ["auras", "enchantments", "combat"], "commanderImportance": 1.5},
    "Fae Dominion": {"archetype": "Faeries and instant-speed control", "length": "long", "tags": ["tribal", "flying", "control"], "commanderImportance": 1.5},
    "Timey-Wimey": {"archetype": "Suspend and time counters", "length": "long", "tags": ["suspend", "counters", "value"], "commanderImportance": 1.5},
    ...
    "Corrupting Influence": {"archetype": "Poison And Corrupted", "length": "medium", "tags": ["poison", "counters", "proliferate"], "commanderImportance": 1.5},
    "Tinker Time": {"archetype": "Differently Named Tokens", "length": "long", "tags": ["artifacts", "tokens", "ramp"], "commanderImportance": 1.5},
    "Growing Threat": {"archetype": "Phyrexians And Incubate", "length": "long", "tags": ["artifacts", "counters", "proliferate"], "commanderImportance": 1.5},
    "Divine Convocation": {"archetype": "Convoke And Creature Tokens", "length": "medium", "tags": ["tokens", "convoke", "spellslinger"], "commanderImportance": 1.5},
    "Cavalry Charge": {"archetype": "Knights And Reanimation", "length": "medium", "tags": ["tribal", "graveyard", "reanimate"], "commanderImportance": 1.5},
    "Call for Backup": {"archetype": "Backup And Combat Counters", "length": "medium", "tags": ["counters", "combat"], "commanderImportance": 1.5},
    "From Cute to Brute": {"archetype": "Five-Color Transformations", "length": "long", "tags": ["ramp", "planeswalkers", "big-creatures"], "commanderImportance": 1.5},
    ...
    'Calling All Angels': {archetype: 'Angels, counters and lifegain', length: 'medium', tags: ['tribal', 'counters', 'lifegain'], commanderImportance: 1.65},
    'Keen Engineering': {archetype: 'Artifacts, Thopters and card advantage', length: 'long', tags: ['artifacts', 'tokens', 'control'], commanderImportance: 1.55},
    'Wretched Ranks': {archetype: 'Zombie tokens, sacrifice and recursion', length: 'long', tags: ['tribal', 'tokens', 'sacrifice', 'graveyard', 'death-triggers'], commanderImportance: 1.5},
    'Reign of Dragons': {archetype: 'Dragons, ramp and damage triggers', length: 'medium', tags: ['tribal', 'tokens', 'ramp', 'combat'], commanderImportance: 1.55},
    'Tramplesaurus Rex': {archetype: 'Creature ramp and trampling finishers', length: 'medium', tags: ['ramp', 'combat'], commanderImportance: 1.35},
