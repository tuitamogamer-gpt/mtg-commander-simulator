...
function showLoading(mode) {
  ...
  veil.innerHTML = `<div><i aria-hidden="true"></i><span>OPENING THE TABLE</span><h2>${mode === 'online' ? 'Preparing Commander Live.' : mode === 'import' ? 'Loading the decklist importer.' : 'Loading all 75 decks.'}</h2><p>The complete rules engine stays in this browser. This first load can take a moment.</p></div>`;
