...
Three original instrumentals and thirteen effects generated through the user's
...
limits concurrent effects and groups simultaneous damage/deaths. The audio
...
Only successful casts, actual land plays, public arrivals and outcome events trigger
effects. Save replay, AI simulations, hidden identities and UI rerenders do not.
...
Verification: `tests/game-audio.test.mjs` and `tests/browser/game-audio.mjs`.
...
running Web Audio graph on desktop and phone layouts.
